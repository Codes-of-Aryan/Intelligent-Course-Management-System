  ...
  return (
    <Container fluid style={{ background: "#C3EAFB", height: "100vh" }}>
      ...
      <Row style={{ textAlign: "center" }}>
        <h2 style={{paddingTop: '2%'}}>{courseDetail.CourseID + " " + courseDetail.CourseName}</h2>
      </Row>
      <Row>
        <Card style={{width: '80%', margin: 'auto'}}>
          <h5 style={{marginLeft: '5%', marginRight: '5%', marginTop: '3%'}}>
          ...
          <Card.Body>
            <Row>
              <Col>
                <Card style={{ backgroundColor: "#F1DEDE" }}>
                  ...
                  <Row>
                    ...
                    <Col>
                      <h6>{courseDetail.ProfessorFirstName + " " + courseDetail.ProfessorLastName}</h6>
                    </Col>
                  </Row>
                  <Row>
                    <Col style={{ textAlign: "center" }}>
              ...
              <Card style={{ backgroundColor: "#F1DEDE" }}>
                  ...
                  <Row>
                    ...
                    <Col>
                      <h6>{courseDetail.LectureStartTime + " - " + courseDetail.LectureEndTime}</h6>
                    </Col>
                  </Row>
                  <Row style={{paddingBottom: '4%'}}>
                    <Col style={{ textAlign: "center" }}>
              ...
              <Card style={{ backgroundColor: "#F1DEDE" }}>
                  ...
                  <Row>
                    ...
                    <Col>
                      <h6> {courseDetail.TutorialStartTime + " - " + courseDetail.TutorialEndTime}</h6>
                    </Col>
                  </Row>
                  <Row style={{paddingBottom: '4%'}}>
                    <Col style={{ textAlign: "center" }}>
            ...
            <Row style={{display: 'block', textAlign: 'center', paddingTop: '3%'}}>
                <span><b>Join Zoom Meeting: </b></span>
                <a href={"" + courseDetail.ZoomLink} target="_blank">
                <Button style={{background:
                            "linear-gradient(0deg, #006EF4, #006EF4), #FFFFFF",
                          width: "20%",}}>Open Zoom Link</Button>
                </a>
            </Row>
            <Row style={{paddingTop: '4%'}}>
                <Col>
                <Card style={{ backgroundColor: "#E1FFEE", width: '75%', margin: 'auto' }}>
                  <Row style={{ textAlign: "center", paddingTop: '4%' }}>
